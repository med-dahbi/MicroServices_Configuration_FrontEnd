...
@Component({
  selector: 'app-gestion-prof-test',
  templateUrl: './gestion-prof-test.component.html',
  styleUrls: ['./gestion-prof-test.component.css']
})
export class GestionProfTestComponent implements OnInit {
  ...
  update(){
    ...
    this.file.saveTestProf(this.PrincipalForm.value).subscribe(
  ...
  ngOnInit(): void {
    this.file.GetTestConfigProf().subscribe(data=>{
      console.log(data);
      this.data=data
