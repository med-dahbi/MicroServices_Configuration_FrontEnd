...
@Component({
  selector: 'app-gestion-prof-dev',
  templateUrl: './gestion-prof-dev.component.html',
  styleUrls: ['./gestion-prof-dev.component.css']
})
export class GestionProfDevComponent implements OnInit {
  ...
  update(){
    ...
    this.file.saveDeveloppementProf(this.PrincipalForm.value).subscribe(
  ...
  ngOnInit(): void {
    this.file.GetDevConfigProf().subscribe(data=>{
      console.log(data);
      this.data=data
